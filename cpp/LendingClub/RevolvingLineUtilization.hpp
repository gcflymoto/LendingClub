...
class RevolvingLineUtilization : public Filter<RevolvingLineUtilization>
{
public:
    ...
    RevolvingLineUtilization(const Arguments& args, unsigned* current = nullptr) : Filter<RevolvingLineUtilization>(name, args)
    {
