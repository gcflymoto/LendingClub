...
class DebtToIncomeRatio : public Filter<DebtToIncomeRatio>
{
public:
    ...
    DebtToIncomeRatio(const Arguments& args, unsigned* current = nullptr) : Filter<DebtToIncomeRatio>(name, args)
    {
